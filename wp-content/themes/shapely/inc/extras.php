...
//2016.06.13 post_type 'counseling' 추가
function create_post_type() {
  register_post_type( 'counseling',
    array(
      'labels' => array(
        'name' => __( 'counselings' ),
        'singular_name' => __( 'counseling' )
      ),
      'public' => true,
      'has_archive' => true,
    )
...
// 2016.06.13 shapely_posted_on --> customize
if ( ! function_exists( 'Jay_posted_on' ) ) :
function Jay_posted_on() {
...
// 2016.06.13 shapely_cb_comment--> customize

function Jay_cb_comment($comment, $args, $depth) {
	...
	<li <?php comment_class( empty( $args['has_children'] ) ? '' : 'parent' ) ?> id="comment-<?php comment_ID() ?>">
      ...
      <?php endif; ?>
        <div class="">
            ...
            <b class="fn"><i class="fa fa-user"></i><span>&nbsp;<?php echo get_comment_author(); ?></span> &nbsp;&nbsp;
              <div class="comment-date">
                <time datetime="2016-01-28T12:43:17+00:00"><i class="fa fa-calendar"></i><span>
                <?php
                  /* translators: 1: date, 2: time */
                  printf( __( '%1$s at %2$s', 'shapely' ), get_comment_date(), get_comment_time() ); ?></span></time>&nbsp;<?php edit_comment_link( __( 'Edit', 'shapely' ), '  ', '' );
                ?>
               &nbsp;&nbsp;
 ...
 */
 ...
 // 2016.06.08 shapely_top_callout() 수정!! is_category() 추가
 // 2016.06.13 shapely_top_callout() 수정!! is_singular('counseling') 추가
                  ...
                  <h3 class="page-title">
                      ...
                      if( is_home() ){
                        ...
                        _e( 'Search'  , 'shapely' );
												...
												if(is_singular('counseling')){
													echo "고민에 대해 이야기해보세요";
												}else if(is_page(2218)){
                          echo "고민이 등록되었습니다";
                        }
                        else{
